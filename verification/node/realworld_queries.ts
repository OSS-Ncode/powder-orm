// Real-world business-query verification for the Powder Node bindings (TypeScript).
// Mirrors verification/cpp/realworld_queries.cpp and SCENARIOS.md: 14 scenarios
// against an e-commerce dataset via raw SQL, the typed generated models,
// relations, aggregations, named-query style, and nested transactions.

import { Client, PowderError, runNamedQuery } from "@powder/node";
import { powder, type PowderClient } from "./powder_models.js";
...
async function main(): Promise<void> {
  ...
  const db: PowderClient = powder(client);
